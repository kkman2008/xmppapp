...
import com.yyquan.zkzx.util.TimeUtil;
import com.yyquan.zkzx.entity.XmppMessage;
...
public class XmppContentProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        switch (matcher.match(uri)) {
            case MESSAGE:
                return "vnd.android.cursor.item/com.yyquan.zkzx";
            case MESSAGES:
                return "vnd.android.cursor.dir/com.yyquan.zkzx";
            default:
