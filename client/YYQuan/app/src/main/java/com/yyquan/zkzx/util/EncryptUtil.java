...
public class EncryptUtil {
	...
	public static  String TAG = "Encrypt Util";
	public static void main(String[] args) {
	String encstr1 =	encryptAES("This is source string...", "zkyt");
		String encstr =	encryptAES("土壤污染对食品安全有直接的影响，我们的食物质量和安全与土壤污染物质直接相关。其原因是植物通过多种渠道吸收土壤污染物质，并且在食物链中积累，进而引起了人类和动物的食物安全问题。另外，达到致毒水平的污染物还可以抑制作物生长和减少土壤生物多样性，进而降低作物产量，导致粮食安全问题。\n" +
				"\n", "zkyt");
		String srcstr = decryptAES(encstr, "zkyt");
