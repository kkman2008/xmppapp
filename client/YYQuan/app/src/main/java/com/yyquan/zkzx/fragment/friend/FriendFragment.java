...
//                });
            ...
            if (xf.getUser().getIcon() == null || xf.getUser().getIcon().equals("")) {
                if (xf.getUser().getSex() ==null || xf.getUser().getSex().equals("男")) {
