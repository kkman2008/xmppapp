package com.yyquan.zkzx.adapter;
...
import com.yyquan.zkzx.entity.News_pinglun;
import com.yyquan.zkzx.activity.GlobalApplication;
 ...
 */
public class LunTanPingLunListViewAdapter extends BaseAdapter {
    Context context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (user.equals(news.get(position).getUser().getUser())) {
